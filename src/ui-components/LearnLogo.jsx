      ...
      >
        ...
        >
          <Icon
            width="13.88px"
            height="12px"
            viewBox={{ minX: 0, minY: 0, width: 13.8798828125, height: 12 }}
            paths={[
              {
          ...
          <Icon
            ...
            top="1.43px"
            left="7.81px"
            {...getOverrideProps(overrides, "Path31472874")}
          ></Icon>
          <Icon
            width="13.88px"
            height="18px"
            viewBox={{ minX: 0, minY: 0, width: 13.8798828125, height: 18 }}
            paths={[
              {
            ...
            top="0px"
            left="10.12px"
            {...getOverrideProps(overrides, "Path31472875")}
          ></Icon>
        </Icon>
      </View>
      <Text
